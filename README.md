...
Extensión de Chrome (Manifest V3) que captura el audio de la pestaña activa y lo procesa **en tiempo real** con la Web Audio API: reducción de ruido, ecualizador de 3 bandas, compresor nivelador de dinámica y paneo estéreo.
...
```
Source → BiquadFilter (lowpass, reducción de ruido)
